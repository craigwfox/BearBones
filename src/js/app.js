...
// Burger menu
// ====---------------====
const burgerWrapper = document.querySelector(".page-nav-wrapper")
if (burgerWrapper) {
	const burgerList = burgerWrapper.querySelector(".page-nav")
	const burgerToggle = burgerWrapper.querySelector(".page-nav-btn")
	...
	// ====---------------====
	const burgerControls = burgerList.querySelectorAll(
		'[data-toggle="nav"]'
	)
